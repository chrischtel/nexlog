...
pub const FieldValue = union(enum) {
    ...
    float: f64,
    boolean: bool,
    array: []const FieldValue, // For arrays/slices
    object: std.StringHashMap(FieldValue), // For nested objects/maps
    null,
...
pub const StructuredField = struct {
    name: []const u8,
    value: FieldValue,
    attributes: ?std.StringHashMap(u8) = null, // Keep if needed
};

pub const StructuredData = []const StructuredField;
